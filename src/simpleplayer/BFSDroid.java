...
public class BFSDroid extends BFS {
    ...
    Direction getBestDir(MapLocation target) throws GameActionException {
        ...
        if (rc.onTheMap(l58)) {
            p58 = 1.0 + 0.1 * rc.senseRubble(l58);
            if (v58 > v71 + p58) {
                v58 = v71 + p58;
                d58 = d71;
            }
        ...
        if (rc.onTheMap(l82)) {
            p82 = 1.0 + 0.1 * rc.senseRubble(l82);
            if (v82 > v83 + p82) {
                v82 = v83 + p82;
                d82 = d83;
            }
        ...
        if (rc.onTheMap(l86)) {
            p86 = 1.0 + 0.1 * rc.senseRubble(l86);
            if (v86 > v85 + p86) {
                v86 = v85 + p86;
                d86 = d85;
            }
        ...
        if (rc.onTheMap(l110)) {
            p110 = 1.0 + 0.1 * rc.senseRubble(l110);
            if (v110 > v97 + p110) {
                v110 = v97 + p110;
                d110 = d97;
            }
        ...
        if (rc.onTheMap(l57)) {
            p57 = 1.0 + 0.1 * rc.senseRubble(l57);
            if (v57 > v71 + p57) {
                v57 = v71 + p57;
                d57 = d71;
            }
        ...
        if (rc.onTheMap(l59)) {
            p59 = 1.0 + 0.1 * rc.senseRubble(l59);
            if (v59 > v71 + p59) {
                v59 = v71 + p59;
                d59 = d71;
            }
        ...
        if (rc.onTheMap(l69)) {
            p69 = 1.0 + 0.1 * rc.senseRubble(l69);
            if (v69 > v83 + p69) {
                v69 = v83 + p69;
                d69 = d83;
            }
        ...
        if (rc.onTheMap(l73)) {
            p73 = 1.0 + 0.1 * rc.senseRubble(l73);
            if (v73 > v85 + p73) {
                v73 = v85 + p73;
                d73 = d85;
            }
        ...
        if (rc.onTheMap(l95)) {
            p95 = 1.0 + 0.1 * rc.senseRubble(l95);
            if (v95 > v83 + p95) {
                v95 = v83 + p95;
                d95 = d83;
            }
        ...
        if (rc.onTheMap(l99)) {
            p99 = 1.0 + 0.1 * rc.senseRubble(l99);
            if (v99 > v85 + p99) {
                v99 = v85 + p99;
                d99 = d85;
            }
        ...
        if (rc.onTheMap(l109)) {
            p109 = 1.0 + 0.1 * rc.senseRubble(l109);
            if (v109 > v97 + p109) {
                v109 = v97 + p109;
                d109 = d97;
            }
        ...
        if (rc.onTheMap(l111)) {
            p111 = 1.0 + 0.1 * rc.senseRubble(l111);
            if (v111 > v97 + p111) {
                v111 = v97 + p111;
                d111 = d97;
            }
        ...
        if (rc.onTheMap(l56)) {
            p56 = 1.0 + 0.1 * rc.senseRubble(l56);
            if (v56 > v70 + p56) {
                v56 = v70 + p56;
                d56 = d70;
            }
        ...
        if (rc.onTheMap(l60)) {
            p60 = 1.0 + 0.1 * rc.senseRubble(l60);
            if (v60 > v72 + p60) {
                v60 = v72 + p60;
                d60 = d72;
            }
        ...
        if (rc.onTheMap(l108)) {
            p108 = 1.0 + 0.1 * rc.senseRubble(l108);
            if (v108 > v96 + p108) {
                v108 = v96 + p108;
                d108 = d96;
            }
        ...
        if (rc.onTheMap(l112)) {
            p112 = 1.0 + 0.1 * rc.senseRubble(l112);
            if (v112 > v98 + p112) {
                v112 = v98 + p112;
                d112 = d98;
            }
        ...
        if (rc.onTheMap(l45)) {
            p45 = 1.0 + 0.1 * rc.senseRubble(l45);
            if (v45 > v58 + p45) {
                v45 = v58 + p45;
                d45 = d58;
            }
        ...
        if (rc.onTheMap(l81)) {
            p81 = 1.0 + 0.1 * rc.senseRubble(l81);
            if (v81 > v82 + p81) {
                v81 = v82 + p81;
                d81 = d82;
            }
        ...
        if (rc.onTheMap(l87)) {
            p87 = 1.0 + 0.1 * rc.senseRubble(l87);
            if (v87 > v86 + p87) {
                v87 = v86 + p87;
                d87 = d86;
            }
        ...
        if (rc.onTheMap(l123)) {
            p123 = 1.0 + 0.1 * rc.senseRubble(l123);
            if (v123 > v110 + p123) {
                v123 = v110 + p123;
                d123 = d110;
            }
        ...
        if (rc.onTheMap(l44)) {
            p44 = 1.0 + 0.1 * rc.senseRubble(l44);
            if (v44 > v58 + p44) {
                v44 = v58 + p44;
                d44 = d58;
            }
        ...
        if (rc.onTheMap(l46)) {
            p46 = 1.0 + 0.1 * rc.senseRubble(l46);
            if (v46 > v58 + p46) {
                v46 = v58 + p46;
                d46 = d58;
            }
        ...
        if (rc.onTheMap(l68)) {
            p68 = 1.0 + 0.1 * rc.senseRubble(l68);
            if (v68 > v82 + p68) {
                v68 = v82 + p68;
                d68 = d82;
            }
        ...
        if (rc.onTheMap(l74)) {
            p74 = 1.0 + 0.1 * rc.senseRubble(l74);
            if (v74 > v86 + p74) {
                v74 = v86 + p74;
                d74 = d86;
            }
        ...
        if (rc.onTheMap(l94)) {
            p94 = 1.0 + 0.1 * rc.senseRubble(l94);
            if (v94 > v82 + p94) {
                v94 = v82 + p94;
                d94 = d82;
            }
        ...
        if (rc.onTheMap(l100)) {
            p100 = 1.0 + 0.1 * rc.senseRubble(l100);
            if (v100 > v86 + p100) {
                v100 = v86 + p100;
                d100 = d86;
            }
        ...
        if (rc.onTheMap(l122)) {
            p122 = 1.0 + 0.1 * rc.senseRubble(l122);
            if (v122 > v110 + p122) {
                v122 = v110 + p122;
                d122 = d110;
            }
        ...
        if (rc.onTheMap(l124)) {
            p124 = 1.0 + 0.1 * rc.senseRubble(l124);
            if (v124 > v110 + p124) {
                v124 = v110 + p124;
                d124 = d110;
            }
        ...
        if (rc.onTheMap(l43)) {
            p43 = 1.0 + 0.1 * rc.senseRubble(l43);
            if (v43 > v57 + p43) {
                v43 = v57 + p43;
                d43 = d57;
            }
        ...
        if (rc.onTheMap(l47)) {
            p47 = 1.0 + 0.1 * rc.senseRubble(l47);
            if (v47 > v59 + p47) {
                v47 = v59 + p47;
                d47 = d59;
            }
        ...
        if (rc.onTheMap(l55)) {
            p55 = 1.0 + 0.1 * rc.senseRubble(l55);
            if (v55 > v69 + p55) {
                v55 = v69 + p55;
                d55 = d69;
            }
        ...
        if (rc.onTheMap(l61)) {
            p61 = 1.0 + 0.1 * rc.senseRubble(l61);
            if (v61 > v73 + p61) {
                v61 = v73 + p61;
                d61 = d73;
            }
        ...
        if (rc.onTheMap(l107)) {
            p107 = 1.0 + 0.1 * rc.senseRubble(l107);
            if (v107 > v95 + p107) {
                v107 = v95 + p107;
                d107 = d95;
            }
        ...
        if (rc.onTheMap(l113)) {
            p113 = 1.0 + 0.1 * rc.senseRubble(l113);
            if (v113 > v99 + p113) {
                v113 = v99 + p113;
                d113 = d99;
            }
        ...
        if (rc.onTheMap(l121)) {
            p121 = 1.0 + 0.1 * rc.senseRubble(l121);
            if (v121 > v109 + p121) {
                v121 = v109 + p121;
                d121 = d109;
            }
        ...
        if (rc.onTheMap(l125)) {
            p125 = 1.0 + 0.1 * rc.senseRubble(l125);
            if (v125 > v111 + p125) {
                v125 = v111 + p125;
                d125 = d111;
            }
        ...
        if (rc.onTheMap(l32)) {
            p32 = 1.0 + 0.1 * rc.senseRubble(l32);
            if (v32 > v45 + p32) {
                v32 = v45 + p32;
                d32 = d45;
            }
        ...
        if (rc.onTheMap(l80)) {
            p80 = 1.0 + 0.1 * rc.senseRubble(l80);
            if (v80 > v81 + p80) {
                v80 = v81 + p80;
                d80 = d81;
            }
        ...
        if (rc.onTheMap(l88)) {
            p88 = 1.0 + 0.1 * rc.senseRubble(l88);
            if (v88 > v87 + p88) {
                v88 = v87 + p88;
                d88 = d87;
            }
        ...
        if (rc.onTheMap(l136)) {
            p136 = 1.0 + 0.1 * rc.senseRubble(l136);
            if (v136 > v123 + p136) {
                v136 = v123 + p136;
                d136 = d123;
            }
        ...
        if (rc.onTheMap(l31)) {
            p31 = 1.0 + 0.1 * rc.senseRubble(l31);
            if (v31 > v45 + p31) {
                v31 = v45 + p31;
                d31 = d45;
            }
        ...
        if (rc.onTheMap(l33)) {
            p33 = 1.0 + 0.1 * rc.senseRubble(l33);
            if (v33 > v45 + p33) {
                v33 = v45 + p33;
                d33 = d45;
            }
        ...
        if (rc.onTheMap(l67)) {
            p67 = 1.0 + 0.1 * rc.senseRubble(l67);
            if (v67 > v81 + p67) {
                v67 = v81 + p67;
                d67 = d81;
            }
        ...
        if (rc.onTheMap(l75)) {
            p75 = 1.0 + 0.1 * rc.senseRubble(l75);
            if (v75 > v87 + p75) {
                v75 = v87 + p75;
                d75 = d87;
            }
        ...
        if (rc.onTheMap(l93)) {
            p93 = 1.0 + 0.1 * rc.senseRubble(l93);
            if (v93 > v81 + p93) {
                v93 = v81 + p93;
                d93 = d81;
            }
        ...
        if (rc.onTheMap(l101)) {
            p101 = 1.0 + 0.1 * rc.senseRubble(l101);
            if (v101 > v87 + p101) {
                v101 = v87 + p101;
                d101 = d87;
            }
        ...
        if (rc.onTheMap(l135)) {
            p135 = 1.0 + 0.1 * rc.senseRubble(l135);
            if (v135 > v123 + p135) {
                v135 = v123 + p135;
                d135 = d123;
            }
        ...
        if (rc.onTheMap(l137)) {
            p137 = 1.0 + 0.1 * rc.senseRubble(l137);
            if (v137 > v123 + p137) {
                v137 = v123 + p137;
                d137 = d123;
            }
        ...
        if (rc.onTheMap(l42)) {
            p42 = 1.0 + 0.1 * rc.senseRubble(l42);
            if (v42 > v56 + p42) {
                v42 = v56 + p42;
                d42 = d56;
            }
        ...
        if (rc.onTheMap(l48)) {
            p48 = 1.0 + 0.1 * rc.senseRubble(l48);
            if (v48 > v60 + p48) {
                v48 = v60 + p48;
                d48 = d60;
            }
        ...
        if (rc.onTheMap(l120)) {
            p120 = 1.0 + 0.1 * rc.senseRubble(l120);
            if (v120 > v108 + p120) {
                v120 = v108 + p120;
                d120 = d108;
            }
        ...
        if (rc.onTheMap(l126)) {
            p126 = 1.0 + 0.1 * rc.senseRubble(l126);
            if (v126 > v112 + p126) {
                v126 = v112 + p126;
                d126 = d112;
            }
        ...
        if (rc.onTheMap(l30)) {
            p30 = 1.0 + 0.1 * rc.senseRubble(l30);
            if (v30 > v44 + p30) {
                v30 = v44 + p30;
                d30 = d44;
            }
        ...
        if (rc.onTheMap(l34)) {
            p34 = 1.0 + 0.1 * rc.senseRubble(l34);
            if (v34 > v46 + p34) {
                v34 = v46 + p34;
                d34 = d46;
            }
        ...
        if (rc.onTheMap(l54)) {
            p54 = 1.0 + 0.1 * rc.senseRubble(l54);
            if (v54 > v68 + p54) {
                v54 = v68 + p54;
                d54 = d68;
            }
        ...
        if (rc.onTheMap(l62)) {
            p62 = 1.0 + 0.1 * rc.senseRubble(l62);
            if (v62 > v74 + p62) {
                v62 = v74 + p62;
                d62 = d74;
            }
        ...
        if (rc.onTheMap(l106)) {
            p106 = 1.0 + 0.1 * rc.senseRubble(l106);
            if (v106 > v94 + p106) {
                v106 = v94 + p106;
                d106 = d94;
            }
        ...
        if (rc.onTheMap(l114)) {
            p114 = 1.0 + 0.1 * rc.senseRubble(l114);
            if (v114 > v100 + p114) {
                v114 = v100 + p114;
                d114 = d100;
            }
        ...
        if (rc.onTheMap(l134)) {
            p134 = 1.0 + 0.1 * rc.senseRubble(l134);
            if (v134 > v122 + p134) {
                v134 = v122 + p134;
                d134 = d122;
            }
        ...
        if (rc.onTheMap(l138)) {
            p138 = 1.0 + 0.1 * rc.senseRubble(l138);
            if (v138 > v124 + p138) {
                v138 = v124 + p138;
                d138 = d124;
            }
